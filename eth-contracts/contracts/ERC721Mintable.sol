...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(!_paused, "Contrzct is paused!");
        _;
    }
    ...
    function setPausableState(bool pausableState) external onlyOwner {
        _paused = pausableState;
        if (_paused) {
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOfToken, "The transfer to address cannot be the owner of the given tokenId");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(approvalAddress != address(0), "No approval exists for the given token");
...
contract RealEstateMarketplaceERC721Token is ERC721Metadata("Real Estate Marketplace", "REM", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {

    //constructor() ERC721Metadata("Real Estate Marketplace", "REM", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") public {}
